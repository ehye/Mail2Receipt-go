...
- Every PDF page must be A5 portrait. Rendering uses a fixed `0.83` scale and generates as many pages as content requires. CSS owns the 2 mm page margin, leaving a 144 x 206 mm printable area, so CDP PDF margins remain zero.
